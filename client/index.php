        ...
        <div class="chat-item not-me">
            <div class="clearfix">
                ...
                <div class="msg-bubble-box">
                    <div class="msg-username red-3">温馨提示</div>
    ...
    <div style="display: block;" class="msg-box">
        <div class="chat-item not-me">
            <div class="clearfix">
                ...
                <div class="msg-bubble-box">
                    <div class="msg-username red-3">系统代发红包</div>
                    <div class="msg-bubble-area">
                        <div class="msg-bubble">
                            <p>
                                下一个红包即将发出
...
<script type="text/html" id="system_user_rob_packet_info">
    <div class="chat-status chat-system-notice chat-rob-packet">
        <div class="chat-content-out">
            ...
            <span><%=geter_name%>抢到<%=payer_name%></span>
    ...
    <div class="chat-status chat-system-notice chat-next-packet">
        <div class="chat-content-out">
            ...
            <div class="chat-content-desc">
                <span>下一个红包由</span>
                <span style="max-width: 80px" ><%=payer_name%></span>
                <span>发出</span>
            </div>
        </div>
    </div>
...
<div class="welfareRule hide">
    ...
    <div class="welfareRuleContent ">
        <p class="red red-5">◆玩法说明◆</p>
        <p>每次发10元随机红包，4人抢，抢到最小包的玩家继续发</p>
        <p class="red red-5">◆游戏规则◆</p>
        <p>1.为保障游戏公平，避免逃包现象，红包将由系统自动代发；</p>
        <p>2.玩家的账户余额必须大于10元，保证可以继续发红包；</p>
        <p>3.抢到的红包将自动存入玩家账户，可随时提现；</p>
        <p>4.本游戏由玩家自愿参加,盈亏自负。平台不收取任何费用，参与游戏即视为同意本条款；</p>
    </div>
